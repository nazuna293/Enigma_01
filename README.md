...
3. [ビルドガイド](#3-ビルドガイド)  
  ...
  3-2. [親指キーの配列変更方法](#3-2-親指キーの配列変更方法)  
  3-3. [タクトスイッチキット取付方法](#3-3-タクトスイッチキット取付方法)  
  3-4. [リポバッテリー取付方法](#3-4-リポバッテリー取付方法)  
  3-5. [choc v1キースイッチ注意事項](#3-5-choc v1キースイッチ注意事項)  
4. [注意事項](#4-注意事項)  
